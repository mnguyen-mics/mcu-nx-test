...
export default class ObjectNodeFactory extends AbstractNodeFactory<ObjectNodeModel> {
  ...
  generateReactWidget(diagramEngine: MicsDiagramEngine, node: ObjectNodeModel): JSX.Element {
    ...
    return (
      <AdvancedSegmentBuilderContext.Consumer>
        {({ query, schema, isTrigger, isEdge }) =>
          React.createElement(ObjectNodeWidget, {
            node: node,
