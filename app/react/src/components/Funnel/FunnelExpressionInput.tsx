...
class FunnelExpressionInput extends React.Component<Props, State> {
  ...
  getInputField(dimensionName: string, from: McsMoment, to: McsMoment) {
    const {
      datamartId,
      match: {
    ...
    const commonProps: ResourceByKeywordSelectorProps = {
      ...
      onchange: this._compose(
        this._map((label: LabeledValue) => label.key),
        handleDimensionExpressionForSelectorChange,
      ),
      showId: true,
      multiselect: true,
    ...
    const commonEnumProps: CommonEnumProps = {
      ...
      filterOption: (inputValue: string, option: any) => {
        const contains = option.prop.value
          ?.toString()
          .toLowerCase()
    ...
    switch (dimensionName) {
      ...
      case 'DEVICE_BROWSER_FAMILY':
        ...
        return (
          <Select {...commonEnumProps} mode='tags' onChange={handleEnumChange}>
      ...
      case 'EVENT_TYPE':
        ...
        return (
          <div id={anchorId}>
            <EventTypeSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'SEGMENT_ID':
        return (
          <div id={anchorId}>
            <SegmentByNameSelector {...commonProps} />
          </div>
        );
      case 'ORIGIN_SUB_CAMPAIGN_ID':
        return (
          <div id={anchorId}>
            <AdGroupByKeywordSelector {...commonProps} />
          </div>
        );
      case 'ORIGIN_CAMPAIGN_ID':
        return (
          <div id={anchorId}>
            <CampaignByKeywordSelector {...commonProps} />
          </div>
        );
      case 'GOAL_ID':
        return (
          <div id={anchorId}>
            <GoalByKeywordSelector {...commonProps} />
          </div>
        );
      case 'CHANNEL_ID':
        return (
          <div id={anchorId}>
            <ChannelByKeywordSelector {...commonProps} />
          </div>
        );
      case 'ORIGIN_CREATIVE_ID':
        return (
          <div id={anchorId}>
            <CreativeByKeywordSelector {...commonProps} />
          </div>
        );
      case 'PRODUCT_ID':
        return (
          <div id={anchorId}>
            <ProductIdByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'CATEGORY1':
        return (
          <div id={anchorId}>
            <Category1ByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'CATEGORY2':
        return (
          <div id={anchorId}>
            <Category2ByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'CATEGORY3':
        return (
          <div id={anchorId}>
            <Category3ByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'CATEGORY4':
        return (
          <div id={anchorId}>
            <Category4ByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'BRAND':
        return (
          <div id={anchorId}>
            <BrandByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'DEVICE_BRAND':
        return (
          <div id={anchorId}>
            <DeviceBrandByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'TYPE':
        return (
          <div id={anchorId}>
            <TypeByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'DEVICE_CARRIER':
        return (
          <div id={anchorId}>
            <DeviceCarrierByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      case 'DEVICE_MODEL':
        return (
          <div id={anchorId}>
            <DeviceModelByNameSelector filter={additionalDimensionFilter} {...commonProps} />
          </div>
        );
      default:
        return (
...
export default compose<FunnelExpressionProps, FunnelExpressionProps>(withRouter)(
