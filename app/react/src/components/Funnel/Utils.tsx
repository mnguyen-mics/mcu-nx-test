...
export const shouldUpdateFunnelQueryBuilder = (previousFunnelFilter: FunnelFilter[], nextFunnelFilter: FunnelFilter[]): boolean => {
...
export const shouldRefetchFunnelData = (previousRouteParams: any, nextRouteParams: any): boolean => {
  const previousFunnelFilter: FunnelFilter[] = previousRouteParams.filter.length > 0 ? JSON.parse(previousRouteParams.filter) : [];
  const nextFunnelFilter: FunnelFilter[] = nextRouteParams.filter.length > 0 ? JSON.parse(nextRouteParams.filter) : [];
