...
export const showFilterOperator: FilterOperatorLabel[] = ['equals', 'in'];

export type EventTypeDimension =
...
export type DeviceFormFactorDimension =
  | 'OTHER'
  | 'PERSONAL_COMPUTER'
  | 'SMART_TV'
  | 'GAME_CONSOLE'
...
export type DeviceOsFamilyDimension = 'OTHER' | 'WINDOWS' | 'MAC_OS' | 'LINUX' | 'ANDROID' | 'IOS';
...
export type DeviceBrowserFamilyDimension =
  | 'OTHER'
  | 'CHROME'
  | 'IE'
  | 'FIREFOX'
