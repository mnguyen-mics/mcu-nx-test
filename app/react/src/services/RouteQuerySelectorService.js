...
const PAGINATION_QUERY_SETTINGS = [
  {
...
const buildDefaultQuery = (existingQuery = {}, settings) => {
...
const updateQueryWithParams = (query, params, settings) => {
...
export {
  PAGINATION_QUERY_SETTINGS,
  FILTERS_QUERY_SETTINGS,
  DATE_QUERY_SETTINGS,
