...
const AttributionModelService = {
  ...
  getAttributionModel(id: string, options: object = {}): Promise<DataResponse<AttributionModel>> {
  ...
  createAttributionModel(organisationId: string, options: object = {}): Promise<DataResponse<AttributionModel>> {
