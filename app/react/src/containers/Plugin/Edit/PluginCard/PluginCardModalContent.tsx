...
> extends React.Component<Props<T>, State> {
      ...
      return (
        <div key={section.title}>
          <PluginSectionGenerator
            ...
            descriptionField={
              index === 0 && descriptionField ? descriptionField : undefined
            }
            small={true}
          />
  ...
  onSubmit = (formValues: any) => {
    ...
    save(
      pluginData,
      formattedProperties,
      (formValues.plugin && formValues.plugin.name) ||
  ...
  public render() {
    ...
    return (
      <div className="plugin-modal" ref={node => (this.node = node)}>
        ...
        >
          <ButtonStyleless onClick={onClose} style={{ marginRight: 0 }}>
            <McsIcon
              type="close"
        ...
        <div className="body">
          <div className="header">
            ...
            <div className="information">
              ...
              <div className="description">
                {pluginLayout.metadata.description}
              </div>
            </div>
          </div>
          <div className="tabs">
          ...
          {selectedTab === 'configuration' ? (
            <div className="footer">
              <ButtonStyleless className={' m-r-20'} onClick={onClose}>
                Close
              </ButtonStyleless>
              <ColoredButton
              ...
              >
                {' '}
                {isLoading ? <Icon type="loading" /> : null} Save
              </ColoredButton>
            </div>
          ) : null}
        </div>
