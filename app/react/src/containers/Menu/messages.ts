...
export default defineMessages({
  ...
  // CAMPAIGNS
  campaignTitle: {
    id: 'menu.campaign.title',
    defaultMessage: 'Campaigns',
  },
  campaignDisplay: {
    id: 'menu.campaign.display',
    defaultMessage: 'Display',
  },
  campaignEmail: {
    id: 'menu.campaign.emails',
    defaultMessage: 'Emails',
  },
  campaignGoals: {
    id: 'menu.campaign.goals',
  ...
  // CREATIVES
  creativesTitle: {
    id: 'menu.creatives.title',
    defaultMessage: 'Creatives',
  },
  creativesDisplay: {
    id: 'menu.creatives.display',
    defaultMessage: 'Display',
  },
  creativesEmails: {
  ...
  libraryStylesheets: {
    id: 'menu.library.Stylesheets',
    defaultMessage: 'Stylesheets',
  },
  libraryAssets: {
    id: 'menu.library.Assets',
  ...
  // DATA STUDIO
  dataStudioTitle: {
    id: 'menu.dataStudio.title',
    defaultMessage: 'Data Studio',
  },
  dataStudioQuery: {
  ...
  lastClickedOrganisation: {
    id: 'menu.last.clicked.organisation',
    defaultMessage: 'Last visited organisation',
  },
  lastClickedCommunity: {
    id: 'menu.last.clicked.community',
    defaultMessage: 'Last visited community',
  },
  usersSettingsTitle: {
  ...
  myOffersSettingsList: {
    id: 'menu.my.offers.list',
