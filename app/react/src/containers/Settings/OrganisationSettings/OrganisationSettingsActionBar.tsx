...
class OrganisationSettingsActionBar extends React.Component<Props> {
  render() {
    ...
    const breadcrumbMessages = defineMessages({ settings: { id: 'settings.organisation.settings', defaultMessage: 'Organisation Settings' } });

    const breadcrumbPaths = [{
      name: formatMessage(breadcrumbMessages.settings),
      url: { pathname: `/v2/o/${organisationId}/settings/organisation`, search: '&tab=labels' },
    }];
    return (
