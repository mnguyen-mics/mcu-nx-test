...
const messages = defineMessages({
  ...
  legalBasisSectionLegalBasisTooltip: {
    ...
    defaultMessage:
      'The lawful basis of the data processing (GDPR - Art. 6.1). Cannot be changed after the creation of the processing.',
  },
  generalSectionTitle: {
  ...
  generalSectionNameTooltip: {
    ...
    defaultMessage:
      'Choose a short name to describe your processing. It will appear in dropdown lists to select a processing (audience segment creation, display campaign creation etc.), or when you read the user consents of a user.',
  },
  ...
  generalSectionTechnicalNameTooltip: {
    ...
    defaultMessage:
      "The 'technical name' is an external key you can provide for a processing in order to retrieve it through API integrations.",
  },
  ...
  generalSectionTokenTooltip: {
    ...
    defaultMessage:
      "The 'token' is a random key you can use in non-authenticated integrations (such as javascript-based website tracking) to create user consents on a given user.",
  },
  ...
  legalBasisSubTitle: {
    ...
    defaultMessage:
      'Select the legal basis of your new Processing Activity. You will not be able to change it afterwards.',
  },
  consentSubTitle: {
  ...
  legitimateInterestSubTitle: {
    ...
    defaultMessage:
      'Processing is necessary for the purposes of the legitimate interests pursued by the controller or by a third party, except where such interests are overriden by the interests or fundamental rights and freedoms of the data subject which require protection of personal data, in particular where the data subject is a child. Shall not apply to processing carried out by public authorities in the performance of their tasks.',
  },
  communityModalMessage: {
    id: 'settings.organisation.processings.list.modal.community',
    defaultMessage:
      'Modification on Processings can only be done at community level. Please confirm to change the organisation you are browsing.',
  },
  deleteModalMessage: {
