...
import { PaginationSearchSettings, SearchSetting, PAGINATION_SEARCH_SETTINGS } from './../../../../utils/LocationSearchHelper';
...
export interface CleaningRulesFilter extends PaginationSearchSettings, CleaningRulesTypeAndDatamartSearchSettings {};
