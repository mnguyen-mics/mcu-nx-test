...
const messages = defineMessages({
  ...
  offerTypePickerSubTitle: {
    id: 'settings.my.service.create.offer.typePicker.subtitle',
    defaultMessage: 'Choose your offer type',
  },
  automaticOfferType: {
    id: 'offer.type.automatic',
    defaultMessage: 'Automatic',
  },
  manualOfferType: {
    id: 'offer.type.manual',
  ...
  generalInformation: {
    id: 'offer.generalInformation',
    defaultMessage: 'General Information',
  },
  automaticOn: {
    id: 'offer.automaticOn',
