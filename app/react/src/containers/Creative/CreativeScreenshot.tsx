...
import { DisplayAdResource, EmailTemplateResource } from '../../models/creative/CreativeResource';
...
class CreativeScreenshot extends React.Component<CreativeScreenshotProps, CreativeScreenshotState> {
  ...
  renderSuccessScreenshot = (record: DisplayAdResource | EmailTemplateResource) => {
    return (
      <a
        target='_blank'
