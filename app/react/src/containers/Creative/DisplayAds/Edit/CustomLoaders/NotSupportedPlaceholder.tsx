...
const messages = defineMessages({
  placeholder: {
    ...
    defaultMessage: 'This plugin has been deprecated. Please contact your plugin developer if you wish to migrate your creative.'
  }
})
...
class NotSupportedPlaceholder extends React.Component<NotSupportedPlaceholderProps, any> {
  render() {
    ...
    return (
      <div className="mcs-custom-loader no-loader">
...
export default compose<NotSupportedPlaceholderProps, {}>(
  injectIntl
