...
class AttributionModelActionBar extends Component<RouteComponentProps<RouterProps> & InjectedIntlProps> {
      ...
      <Actionbar path={breadcrumbPaths}>
        <Link to={`/v2/o/${organisationId}/library/attribution_models/create`}>
          <Button className="mcs-primary" type="primary">
            <McsIcons type="plus" /> <FormattedMessage {...messages.newAttributionModel} />
          </Button>
        </Link>
      </Actionbar>
    );
