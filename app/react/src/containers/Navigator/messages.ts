...
export default defineMessages({
  adBlock: {
    id: 'errors.adBlock',
    defaultMessage: 'It appears you have an adblocker activated, in order to access mediarithmics navigator you need to disable your adblocker. Please contact the support if the issue persists afterwards',
  },
  generic: {
    id: 'errors.generic',
