...
import { GenericCreativeResource, CreativeScreenshotResource } from '../../../models/creative/CreativeResource';
        ...
        return (
          <div>
            <div
              ...
              style={{ backgroundImage: `url('https://ads.mediarithmics.com/ads/screenshot?rid=${creative.id}')` }}
            />
            <div className="image-container">
              <div className="helper" />
              <img className="image" src={`https://ads.mediarithmics.com/ads/screenshot?rid=${creative.id}`} alt={creative.name} />
            </div>
          </div>
        );
      }
    ...
    return (
      <div className="mcs-creative-card">
        ...
        <div className="creative-details">
          <div className="title"><strong>{renderedTitle}</strong></div>
          { renderSubtitles && renderSubtitles.length > 0 && renderSubtitles.map(renderSubtitle => (
