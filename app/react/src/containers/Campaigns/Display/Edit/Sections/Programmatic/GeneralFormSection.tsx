...
import { EditDisplayCampaignRouteMatchParam, DisplayCampaignFormData } from '../../domain';
      ...
      <div>
        ...
        <div>
          ...
          <FormInputField
            ...
            formItemProps={{
              label: formatMessage(formatDisplayCampaignProperty('total_budget').message),
            }}
            inputProps={{
              suffix: <span>€</span>,
                  ...
                  options={[
                    {
                      value: 'DAY',
                      title: 'DAY',
                      children: formatDisplayCampaignProperty('max_budget_period', 'DAY')
                        .formattedValue,
                    },
                    {
                      value: 'WEEK',
                      title: 'WEEK',
                      children: formatDisplayCampaignProperty('max_budget_period', 'WEEK')
                        .formattedValue,
                    },
                    {
                      value: 'MONTH',
                      title: 'MONTH',
                      children: formatDisplayCampaignProperty('max_budget_period', 'MONTH')
                        .formattedValue,
                    },
                  ]}
                />
