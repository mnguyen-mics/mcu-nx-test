...
import PlacementDisplayHeader from './PlacementDisplayHeader';
import PlacementDisplayRow from './PlacementDisplayRow';
import { ButtonStyleless, Form, List } from '../../../../../../../components';
...
*/
    ...
    const placementsToDisplay = (this.state.displayTableOptions
      ? placements.map((elem) => {
        console.log('elem = ', elem);
        return <PlacementDisplayRow key={elem.id} {...elem} />;
      })
      : null
    );
