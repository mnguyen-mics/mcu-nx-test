...
export interface AdvancedSegmentBuilderProps {
...
type Props = AdvancedSegmentBuilderProps;

class AdvancedSegmentBuilder extends React.Component<Props, State> {
...
export default withDragDropContext(AdvancedSegmentBuilder);
