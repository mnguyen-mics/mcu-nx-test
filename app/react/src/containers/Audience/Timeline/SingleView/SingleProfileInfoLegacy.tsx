import { UserProfileResource } from "../../../../models/timeline/timeline";
...
export interface SingleProfileInfoLegacyProps {
...
export default class SingleProfileInfoLegacy extends React.Component<SingleProfileInfoLegacyProps, State> {

    static defaultProps = {
        profileWithAccountId: {}
    }

    constructor(props: SingleProfileInfoLegacyProps) {
        super(props);
        this.state = {
            showMore: false,
        }
