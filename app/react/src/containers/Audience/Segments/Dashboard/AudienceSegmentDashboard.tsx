...
class AudienceSegmentDashboard extends React.Component<Props, State> {
  ...
  fetchDashboardView = (
    ...
    if (datamarts && segment) {
      ...
      this.fetchDashboardChartView(organisationId, segment.datamart_id);
  ...
  fetchDashboardChartView = (organisationId: string, selectedDatamartId: string) => {
    this._dashboardService
      .getDashboards(organisationId, selectedDatamartId, 'SEGMENT', {})
      .then(d => {
        return d.data;
      })
      .then(d => {
