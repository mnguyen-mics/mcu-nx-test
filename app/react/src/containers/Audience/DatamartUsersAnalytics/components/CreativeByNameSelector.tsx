...
import { CreativeResourceShape, GenericCreativeResource } from '../../../../models/creative/CreativeResource';
...
class CreativeResourceFetcher implements ResourceFetcher<CreativeResource> {
  ...
  getForKeyword(options: GetOptions & CreativesOptions): Promise<CreativeResource[]> {
    ...
    return this.creativeService.getCreatives(options.organisation_id, queryOptions)
      .then(res => res.data.sort((a, b) => a.name.localeCompare(b.name)))
  }
}

const CreativeByKeywordSelector = ResourceByKeywordSelector(displayNameAdapted<CreativeResource>(),
