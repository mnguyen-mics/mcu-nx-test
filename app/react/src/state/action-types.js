...
export const ANGULAR_LOADED_SUCCESS = 'ANGULAR_LOADED_SUCCESS';
...
export const STORE_AUDIENCE_SEGMENT_METRICS = 'STORE_AUDIENCE_SEGMENT_METRICS';
export const AUDIENCE_SEGMENT_METRICS = createRequestTypes('AUDIENCE_SEGMENT_METRICS');
export const ALL_AUDIENCE_SEGMENT_METRICS = createRequestTypes('ALL_AUDIENCE_SEGMENT_METRICS');
