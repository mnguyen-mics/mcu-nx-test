...
const fetchAudiencePartitionsList = {
  request: (organisationId, filter = {}, isInitialRender = false, datamartId) => createAction(AUDIENCE_PARTITIONS_LIST_FETCH.REQUEST)({ organisationId, datamartId, filter, isInitialRender }),
