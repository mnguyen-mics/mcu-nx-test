define(['./module'], function (module) {
            ...
            return {
                ...
                link: function ($scope, element, attr) {
                    ...
                    $scope.addPropertySelector = function (family) {
                        ...
                        $uibModal.open({
                            templateUrl: 'angular/src/core/datamart/queries/create-property-selector.html',
                            scope: newScope,
                            backdrop: 'static',
                ...
                templateUrl: function (elem, attr) {
                    return 'angular/src/core/datamart/queries/query-ui.html';
                }
            };
        }]);
    ...
    module.directive('mcsQueryCondition', [ 'core/datamart/queries/common/Common', 'core/datamart/query/QueryService', function (Common, QueryService) {
        return {
            ...
            templateUrl: function (elem, attr) {
                return 'angular/src/core/datamart/queries/condition.html';
            }
        };
    }]);
    ...
    module.directive('mcsQueryConditionValueDateRange', [ 'moment',  function (moment) {
        return {
            ...
            templateUrl: 'angular/src/core/datamart/queries/value-condition-type-date-range.html',
            link:function(scope, elem, attr){
    ...
    */
    module.directive('mcsQueryConditionValueId', [ 'Restangular', 'core/common/auth/Session', 'lodash', function (Restangular,Session,_) {
        return {
            ...
            templateUrl: 'angular/src/core/datamart/queries/value-condition-type-id.html',
            link:function(scope, elem, attr){
              ...
              if (scope.condition.value.property_selector_name === 'SITE_ID'){
                ...
                Restangular.all("audience_segments").getList({"datamart_id": Session.getCurrentDatamartId(),persisted:true,"with_source_datamarts":1,max_results:5000}).then(function(segments) {
    ...
    module.directive('mcsQueryConditionValueSimpleDate', [ 'moment',  function (moment) {
        return {
            ...
            templateUrl: 'angular/src/core/datamart/queries/value-condition-type-date-simple.html',
            link:function(scope, elem, attr){
    ...
    module.directive('mcsQueryConditionValueRelativeDate', [ 'moment', 'lodash',  function (moment,_) {
        ...
        return {
            ...
            templateUrl: 'angular/src/core/datamart/queries/value-condition-type-relative-date.html',
            link:function(scope, elem, attr){
    ...
    module.directive('mcsQueryReadOnlyView', [
      function () {
        ...
        return {
            ...
            templateUrl: 'angular/src/core/datamart/queries/query-readonly-view.html',
            link:function(scope, elem, attr){
