        ...
        return {
            ...
            link:function(scope, elem, attr){
              ...
              if (scope.condition.value.property_selector_name === 'SITE_ID'){
                ...
                Restangular.all("audience_segments").getList({"datamart_id": Session.getCurrentDatamartId(),persisted:true, "with_source_datamarts":1, max_results: 600}).then(function(segments) {
