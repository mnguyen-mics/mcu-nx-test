describe('User Event Cleaning Rules Test', () => {
  ...
  it('should test the cleaning rules update form', () => {
    ...
    cy.readFile('cypress/fixtures/init_infos.json').then((data) => {
      ...
      cy.get(
        `[href="#/v2/o/${data.organisationId}/settings/datamart/cleaning_rules"]`,
      ).click();
      // Add cleaning rule
      ...
      cy.get('button')
        .contains('Save User Event Cleaning Rule')
        .click({ force: true });
      ...
      cy.request({
        ...
        cy.contains('DRAFT')
          ...
          .parent()
          .parent()
          .should('contain', 'APP_VISIT');
        cy.contains('DRAFT')
          .parent()
          .parent()
          .parent()
          .should('contain', 'test_1');
      });
    });
  });
